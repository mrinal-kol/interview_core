...
<?php
/* === ENTIRE ORIGINAL PHP CODE STARTS HERE === */
...
$obj4->total(500);
echo $obj4->bal();
echo "<br>-------------- Basic Encapsulation Example ----------------</br>";
...
echo '<br>------- Polymorphism Example -------</br>';

class classroom{
  public function mk(){ echo "rani"; }
}
class hmkk extends classroom{
   public function mk(){ echo "sachin"; }
}
class bn extends classroom{
  public function mk(){ echo "dhoni"; }
}
...
echo "<br>---------- Difference between array_merge() and array_combine() -----------</br>";
...
echo "<br>------------how to add value of two array -------</br>";
...
echo "<br>-------- Fetch second height number --------</br>";
...
/* === ENTIRE ORIGINAL PHP CODE ENDS HERE === */
?>
...
?>
        ...
        <div class="container">
          <div>What is the difference between single-quoted and double-quoted strings in PHP?</div>
          <div>
            <?php
